...
function part1(rawInput) {
  ...
  const wire1Dic = wire1.reduce(reducer, {
    horizontal: {},
    vertical: {},
    x: 0,
    y: 0
  });
  const wire2Dic = wire2.reduce(reducer, {
    horizontal: {},
    vertical: {},
    x: 0,
    y: 0
...
function part2(rawInput) {
  ...
  Object.entries(wire1Dic.horizontal).forEach(([k, v]) => {
    for (let i = v.range[0]; i < v.range[1]; i += 1) {
